...
describe('VistasService Regression Tests', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  describe('getOcupacionByEmpresa - Regression', () => {
  ...
  describe('getOcupacionByParqueadero - Regression', () => {
  ...
  describe('getHistorialByEmpresa - Regression', () => {
  ...
  describe('getFacturacionByEmpresa - Regression', () => {
  ...
  describe('getIngresosByEmpresa - Regression', () => {
  ...
  describe('procesarPago - Regression', () => {
  ...
  describe('buscarVehiculoPorPlaca - Regression', () => {
