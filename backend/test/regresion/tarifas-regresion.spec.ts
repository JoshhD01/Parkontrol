...
describe('TarifasService Regression Tests', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('crear - Regression', () => {
    ...
    it('should throw NotFoundException if tipoVehiculo not found', async () => {
      ...
      const dto = { idParqueadero: 1, idTipoVehiculo: 999, precioFraccionHora: 1000 };
  ...
  describe('findByParqueaderoYTipo - Regression', () => {
  ...
  describe('actualizar - Regression', () => {
  ...
  describe('findTarifaById - Regression', () => {
