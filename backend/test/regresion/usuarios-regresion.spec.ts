...
describe('UsuariosService Regression Tests', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('findUsuarioByCorreo - Regression', () => {
  ...
  describe('findUsuarioById - Regression', () => {
  ...
  describe('cambiarContrasena - Regression', () => {
